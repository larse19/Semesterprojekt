...
*   https://gist.github.com/floralvikings/10290131?fbclid=IwAR0EXPIvru5p-nVOBkyrrJxJ5pnkyqT5EitK67yI79aNeA0AwK9tXtj-p4w
 */

public class SearchSystem extends TextField {
                ...
                if (getText().length() == 0) {
                    ...
                    if (entries.size() > 0) {
                        ...
                        if (!entriesPopup.isShowing()) {
                            entriesPopup.show(SearchSystem.this, Side.BOTTOM, 0, 0);
                        }
                    } else {
                        entriesPopup.hide();
                    }
